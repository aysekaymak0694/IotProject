...
//OTHER METHODS
	public static void main(String[] args) {
		...
		if(args.length != 0) {
			...
			File input = new File("C:/Users/tosshýba/workspace/BasicOSMParser-master/res/xml/bleruais.osm");
			
			File output = new File("C:/Users/tosshýba/workspace/BasicOSMParser-master/output");
